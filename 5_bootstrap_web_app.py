            ...
            <tr>
                <td>
                    <form action="{{url_for('route_update_state',task_id=task.id)}}" method="POST">
                        ...
                        <input type="submit" style="font-family:Webdings" value="&#97;" class="btn btn-primary">
                        {% else %}
                ...
                <td>
                    <form action="{{url_for('route_delete',task_id=task.id)}}" method="POST" class="position-relative">
                        <input type="submit" style="font-family:Webdings" value='&#114;' class="btn btn-danger position-absolute end-0">
                    </form>
                </td>
            </tr>
            {% endfor %}
